...
def button(text, x, y, w, h, color, screen, size):
	...
	font = pygame.font.Font('001/carton.ttf', size)
...
def title(text, screen, scale, color=(0, 0, 0)):
	font = pygame.font.Font('001/carton.ttf', WIDTH//(len(text)*2))
...
def show_like_interface1(screen):
	screen.fill(BACKGROUND)
	img3 = pygame.image.load("001/3.png")
...
def main():
	...
	while running:
		screen.fill(BACKGROUND)
		img = pygame.image.load("001/1.png")
	...
	if not os.path.exists("001/3.png"):
